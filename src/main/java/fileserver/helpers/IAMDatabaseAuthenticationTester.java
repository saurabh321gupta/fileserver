...
public class IAMDatabaseAuthenticationTester {
    ...
    private static final String RDS_INSTANCE_HOSTNAME = "imagehost.cujdgjdz4oyp.us-east-2.rds.amazonaws.com";
    private static final int RDS_INSTANCE_PORT = 3306;
    private static final String REGION_NAME = "us-east-2";
    private static final String DB_USER = "demouser";
     ...
     * @throws Exception
     */
    public static void setSslProperties() throws Exception {
